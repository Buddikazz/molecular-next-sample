...
function CTABlockView({
  ...
  const bgStyle = screenWidth >= 768 ? containerStyleOne : containerStyleTwo;

  return (
    <div
      className="custom-bg mt-10 h-52 text-white flex flex-col items-center justify-center text-center "
      style={bgStyle}
    >
      <div className="p-8">
        {" "}
        {ctaHeadline && (
          <EditableArea className="text-lg" content={ctaHeadline} />
        )}
      </div>
      <div className="pb-10">
