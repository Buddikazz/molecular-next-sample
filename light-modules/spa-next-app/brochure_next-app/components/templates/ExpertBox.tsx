...
function ExpertBox({
  ...
  return (
    <>
      ...
      <div
        className={`bg-${bgColourSelectValue} flex flex-col items-center lg:items-start  md:flex-row md:items-start tb:flex-row tb:items-center p-10 md:py-10`}
      >
        ...
        <div className="tb:ml-0 tb:mr-20 text-center md:text-start text-white md:w-1/2">
          <div className="mb-8">
            {" "}
            {expertBoxHeadline && <EditableArea content={expertBoxHeadline} />}
          </div>
        </div>
      </div>
    </>
