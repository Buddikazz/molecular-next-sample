  ...
  return (
    <>
      ...
      >
        ...
        className={`px-1 py-2 rounded-md font-${fontTypeSelect} flex-1 text-${textAlign}  border ${text === "" ? `border-transparent bg-primary` : `border-gray-500 bg-${background} `} ${styleClass} text-${textSize} text-${textColour} font-${checkboxBold && "bold"
          }`}
      >
        {text}
      </div>
